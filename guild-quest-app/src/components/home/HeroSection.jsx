const HeroSection = () => {
  return (
    <div className="relative min-h-screen overflow-hidden w-full">
      <div className="absolute inset-0 bg-cover bg-center w-full h-full" style={{ backgroundImage: `url(${import.meta.env.BASE_URL}images/hero/cleaning_with_robot.jpeg)` }}>
      ...
      <div className="relative z-10 w-full px-4 sm:px-6 lg:px-8 flex flex-col items-center justify-center" style={{ minHeight: 'calc(100vh - 100px)' }}>
        <div className="text-center max-w-4xl mx-auto w-full">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-7xl lg:text-8xl xl:text-9xl font-black text-white mb-4 sm:mb-6 tracking-tight leading-tight">CLEANING GUILD</h1>
          <p className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-5xl text-white font-light mb-8 sm:mb-12 tracking-wide">RPG風掃除管理</p>

        ...
        <footer className="bg-gray-900 text-white py-12 sm:py-16 w-full">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center mb-12">
                    ...
                    <div className="w-24 h-1 bg-gradient-to-r from-purple-400 via-pink-400 to-amber-400 mx-auto mb-8"></div>

                    {/* SNSアイコン */}
                    <div className="flex justify-center items-center gap-6 sm:gap-8">
                        <a
                            href="#"
                            className="w-12 h-12 sm:w-14 sm:h-14 flex items-center justify-center rounded-lg bg-white/10 hover:bg-white/20 transition-all hover:scale-110"
                ...
                <div className="flex justify-center mb-12">
                    <button
                        ...
                        className="flex flex-col items-center gap-2 text-white hover:text-amber-400 transition-colors group"
                    >
                ...
                <div className="border-t border-gray-700 pt-8">
                    <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
                        ...
                        <div className="flex gap-6 text-sm">
                            <a href="#" className="hover:text-amber-400 transition-colors">プライバシーポリシー</a>
                            <a href="#" className="hover:text-amber-400 transition-colors">ご利用条件</a>
                        </div>
